# CLAUDE.md — port-forward-utils

Port-forward management helper (e.g. MinIO admin 127.0.0.1:9000 needed before terragrunt run --all); see bin/ and README.md. Shares k8-lib.
